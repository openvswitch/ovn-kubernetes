...
// GetRepresentorMacAddress provides a mock function with given fields: netdev
func (_m *SriovnetOps) GetRepresentorMacAddress(netdev string) (net.HardwareAddr, error) {
