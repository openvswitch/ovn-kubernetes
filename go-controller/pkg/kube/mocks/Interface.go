...
// GetPods provides a mock function with given fields: namespace, labelSelector, fieldSelector
func (_m *KubeInterface) GetPods(namespace string, labelSelector metav1.LabelSelector, fieldSelector string) (*v1.PodList, error) {
	ret := _m.Called(namespace, labelSelector, fieldSelector)

	var r0 *v1.PodList
	if rf, ok := ret.Get(0).(func(string, metav1.LabelSelector, string) *v1.PodList); ok {
		r0 = rf(namespace, labelSelector, fieldSelector)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, metav1.LabelSelector, string) error); ok {
		r1 = rf(namespace, labelSelector, fieldSelector)
	} else {
		r1 = ret.Error(1)
	}
